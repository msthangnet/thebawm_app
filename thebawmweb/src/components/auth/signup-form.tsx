...
const formSchema = z.object({
  ...
  username: z.string().min(3, { message: "Username must be at least 3 characters." }).max(20, "Username must be 20 characters or less.").regex(/^[a-zA-Z0-9_]+$/, "Username can only contain letters, numbers, and underscores."),
...
export function SignupForm() {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      toast({
        title: "Account Created",
        description: "Welcome to The Bawm!",
      });
      router.push("/");
    } catch (error: any) {
      toast({
