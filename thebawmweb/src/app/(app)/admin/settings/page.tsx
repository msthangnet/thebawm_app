...
import { PostPermissions, DefaultPostPermissions, UserTypes } from "@/lib/types";
...
export default function AdminSettingsPage() {
    ...
    const fetchPermissions = useCallback(async () => {
        ...
        try {
            ...
            if (docSnap.exists()) {
                // Merge with defaults to ensure new permissions are present
    ...
    const handlePermissionChange = (type: keyof PostPermissions, userType: string, value: any) => {
        setPermissions(prev => {
            ...
            if (type === 'dailyPostLimit' || type === 'imageUploadLimit') {
                ...
                // Ensure the property is an array before trying to modify it
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            toast({ title: "Settings Saved", description: "Post permissions have been updated successfully." });
        } catch (error) {
    ...
    return (
        <div className="container mx-auto py-8">
            <Card>
                <CardHeader>
                    <CardTitle>Admin Post Settings</CardTitle>
                    <CardDescription>Control who can post, what they can post, and how often.</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="space-y-6">
                        ...
                        {UserTypes.filter(type => type !== 'Inactive' && type !== 'Suspended').map(userType => (
                            <PermissionRow
                                key={userType}
                                userType={userType}
