...
export default function MarketplaceSettingsPage() {
    ...
    const fetchPermissions = useCallback(async () => {
        ...
        try {
            ...
            if (docSnap.exists()) {
                ...
                await setDoc(settingsRef, DefaultMarketplacePermissions);
    ...
    return (
        <div className="container mx-auto py-8">
            <Card>
                <CardHeader>
                    <CardTitle>Marketplace Seller Settings</CardTitle>
                    <CardDescription>Grant specific users the permission to add products to the marketplace.</CardDescription>
                </CardHeader>
                <CardContent>
